...
class Room:
    def __init__(self, name: str, image_path: str, click_actions, drag_items: list, room_states: dict, room_tasks: list):
        self.name = name
        self.image_path = image_path
        self.click_actions = click_actions
        self.drag_items = drag_items
        self.exits = []
        self.game_state = room_states #Determines if something was done or not
        self.tasks = room_tasks # Task list for the specific room
